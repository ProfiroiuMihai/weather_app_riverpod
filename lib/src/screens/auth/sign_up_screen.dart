...
import 'package:weather_app_test/src/state_notifiers/authentication/sign_up_notifier.dart';
...
class SignUpScreen extends ConsumerWidget {
  ...
  void _listenToProvider(BuildContext context, WidgetRef ref) {
    ref.listen(signUpProvider, (previous, next) {
      final SignUpState signUpState = next as SignUpState;
      if (signUpState is SignUpStateError) {
        _buttonController.stop();
        onCrashedAuth(context, signUpState.message);
      }
  ...
  Future<void> signUp(BuildContext context, WidgetRef ref) async {
    ...
    if (_formKey.currentState!.validate()) {
      ref
          ...
          .signUp(Tuple2(_emailController.text, _passwordController.text));
    } else {
      _buttonController.stop();
    }
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                AppTextButton(
                  label: AppLocalizations.of(context)!.i_already_have_account,
