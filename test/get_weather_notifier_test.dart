...
void main() {
  ...
  NewLocation location=  NewLocation(locationName: "locationName", startDate: DateTime.now(), locationLat: 123, locationLong: 123);
  ...
  test(
    ...
    () async {
      ...
      future.then((value) =>
          expect(sut.state, NetworkTaskState.success([location]))
      );
    },
  );
